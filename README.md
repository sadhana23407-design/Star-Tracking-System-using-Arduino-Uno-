...
References:
I have prior experience with C++, but I am new to working with electronics and hardware systems. I referred to online resources and tutorials to understand circuit connections and Arduino-specific implementation. The project was then built and modified based on my understanding of how the components and code interact
